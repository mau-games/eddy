...
public class TensionGADimensionGrammar extends GADimensionGrammar {

	double patternMultiplier = 4.0;

	public TensionGADimensionGrammar(float granularity)
	{
		super();
		dimension = GrammarDimensionTypes.TENSION;

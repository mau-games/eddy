 ...
 */
public class Base2DesignViewController extends BorderPane implements Listener
{
...
//	private InteractiveMap mapView;
    ...
    public Base2DesignViewController() {
        super();
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
                "/gui/interactive/Base2DesignView.fxml"));
...
//	}
    ...
    public void saveEditedRoomInfo()
    {
        ...
        sb.append("1.0;");  //score
        sb.append("TASK2_NO_DIM_1" + ";");
        sb.append("TASK2_NO_DIM_2" + ";");

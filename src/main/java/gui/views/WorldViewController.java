...
public class WorldViewController extends BorderPane implements Listener
{
	...
	private Button narrativeViewBtn = new Button();
...
//		arrangeControls(mView, 0, 200, 50, 50);
		...
		arrangeControls(narrativeViewBtn, 0,325 , 200,50); //story-narrative
...
//		buttonPane.getChildren().add(getPickInitBtn());
		...
		//story-narrative
		buttonPane.getChildren().add(narrativeViewBtn);
...
//		removeRoomBtn.setText("REMOVE ROOM");
		...
		narrativeViewBtn.setText("Narrative Generator");
		narrativeViewBtn.setTooltip(new Tooltip(("Open the Story Editor")));
...
//		
		...
		narrativeViewBtn.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {

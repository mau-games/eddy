...
//	            	EventRouter.getInstance().postEvent(new SuggestedMapSelected(self));
	            	selected = !selected;
	            	highlight(selected);
					self.possibleRoom.setPositive(selected);
	            }
	        });
	...
	public MetricExampleRooms getPossibleRoom() {return this.possibleRoom;}
    ...
    public void setExampleRoom(Room room, GADimensionsGranularity granularity, double metricScore)
	{
		possibleRoom = new MetricExampleRooms(room, granularity, metricScore, false);
	}
}
